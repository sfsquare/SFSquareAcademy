...
namespace SFSAcademy
{
    ...
    public partial class SFSAcademyEntities : DbContext
    {
        ...
        public virtual DbSet<BATCH_EVENT> BATCH_EVENT { get; set; }
        public virtual DbSet<BATCH_GROUP> BATCH_GROUP { get; set; }
        public virtual DbSet<BATCH_SEAT> BATCH_SEAT { get; set; }
        public virtual DbSet<BATCH_STUDENT> BATCH_STUDENT { get; set; }
        ...
        public virtual DbSet<GROUP_FILE> GROUP_FILE { get; set; }
        public virtual DbSet<GROUP_MEMBER> GROUP_MEMBER { get; set; }
        public virtual DbSet<GROUP_POST> GROUP_POST { get; set; }
        public virtual DbSet<GROUP_POST_COMMENT> GROUP_POST_COMMENT { get; set; }
        public virtual DbSet<GROUPED_BATCH> GROUPED_BATCH { get; set; }
        public virtual DbSet<GROUPED_EXAM> GROUPED_EXAM { get; set; }
        public virtual DbSet<GROUPED_EXAM_REPORT> GROUPED_EXAM_REPORT { get; set; }
        ...
        public virtual DbSet<STORE_INVENTORY> STORE_INVENTORY { get; set; }
        public virtual DbSet<STORE_PROCUREMENT> STORE_PROCUREMENT { get; set; }
        ...
        public virtual DbSet<STORE_SELLING> STORE_SELLING { get; set; }
        public virtual DbSet<STORE_SELLING_BACKUP> STORE_SELLING_BACKUP { get; set; }
        public virtual DbSet<STORE_SELLING_CART> STORE_SELLING_CART { get; set; }
        ...
        public virtual DbSet<USERS_EVENT> USERS_EVENT { get; set; }
        ...
        {
            var galleryNameParameter = galleryName != null ?
                new ObjectParameter("GalleryName", galleryName) :
                new ObjectParameter("GalleryName", typeof(string));
            ...
            var galleryDescriptionParameter = galleryDescription != null ?
                new ObjectParameter("GalleryDescription", galleryDescription) :
                new ObjectParameter("GalleryDescription", typeof(string));
    
            var imageNameParameter = imageName != null ?
                new ObjectParameter("ImageName", imageName) :
                new ObjectParameter("ImageName", typeof(string));
    
            var photoDescriptionParameter = photoDescription != null ?
                new ObjectParameter("PhotoDescription", photoDescription) :
                new ObjectParameter("PhotoDescription", typeof(string));
    
            var thumbPathParameter = thumbPath != null ?
                new ObjectParameter("ThumbPath", thumbPath) :
                new ObjectParameter("ThumbPath", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_GalleryMaster", galleryNameParameter, galleryIdParameter, galleryDescriptionParameter, imageNameParameter, photoDescriptionParameter, thumbPathParameter, imagePathParameter, flagParameter, iD);
        }
    }
}
